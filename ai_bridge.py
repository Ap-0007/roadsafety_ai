...
_TYPE_TO_CAT: dict[str, Optional[str]] = {
    "pothole":         "pothole",
    "road_crack":      "pothole",     # CV pothole detector catches cracks too
    "accident":        "accident",
...
class AIBridge:
    ...
    def model_name(self) -> str:
        if not self.available:
            return "CV fallback"
        has_pt = self._detector and self._detector.has_pothole_model
        return f"YOLOv8s{' + pothole.pt' if has_pt else ' + CV'}"
